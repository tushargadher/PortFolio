    ...
    <section id="achievements" className="py-32 relative bg-background border-t border-border">
      <div className="container mx-auto px-6 max-w-5xl">
        <motion.div 
          ...
          className="mb-16"
        >
          <h2 className="text-sm font-medium tracking-wide uppercase text-secondary mb-2">Metrics</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {stats.map((stat, idx) => (
            <motion.div
              ...
              className="premium-card rounded-2xl p-8 flex flex-col items-start group"
            >
              <div className="w-12 h-12 rounded-xl bg-surface border border-border flex items-center justify-center mb-8">
                {stat.icon}
              </div>
